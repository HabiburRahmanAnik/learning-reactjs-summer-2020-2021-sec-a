...
--
-- Host: 127.0.0.1
-- Generation Time: Aug 03, 2021 at 10:07 AM
...
(6, 'double bed', 2200, 'anik', 38373683, 202),
(7, 'single bed', 1000, 'anik', 1875306465, 201),
(8, 'single bed', 1200, 'anik', 1617455216, 304),
(9, 'single bed', 1000, 'anik', 1617455216, 201);
...
(6, 'korim', 'korim', '14324323254', 'fsadf');
...
(1, 'Adnan', 'working', 'I face problem when i try to login'),
(2, 'anik', 'working', 'My account is deactive.Can you please activted it'),
(3, 'anik', 'pending', 'login problem'),
(4, 'anik', 'pending', 'login problem');
...
(1, 'single bed', 1000, 'booked', 201),
(2, 'double bed', 2200, 'booked', 202),
(3, 'single bed', 1200, 'booked', 304),
...
(1, 'Md.Habibur Rahman', 'habibur', 'habib@gmail.com', 'Habib$12', 'admin', 'O+', '01617455222', 'Dhaka,Bangladesh', '1626539986.jpg', 1, '', ''),
(59, '', 'anik', 'anik26452@gmail.com', '', '', '', '', '', '', 1, '', ''),
(64, '', 'korim', 'korim@gmail.com', '', '', '', '', '', '', 1, '', ''),
(66, '', 'kamal', 'kamal@gmail.com', '', '', '', '', '', '', 1, '', '');
